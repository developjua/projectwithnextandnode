...
export async function getServerSideProps() {
  const res = await fetch(
    "http://localhost:5000/api/data/users/last-name-starts-with-m-and-quote-length-greater-than-15"
  );
...
export default UserTableLastname